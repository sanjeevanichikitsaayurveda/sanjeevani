    ...
    <div className="rounded-2xl shadow-2xl overflow-hidden">
      <div className="p-8 md:p-10" 
        style={{ 
          ...
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%234CAF50' fill-opacity='0.05' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='1.5'/%3E%3Ccircle cx='13' cy='13' r='1.5'/%3E%3C/g%3E%3C/svg%3E")`,
        ...
        {submitStatus === 'success' ? (
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-2" style={{ color: '#2E7D32' }}>Message Sent Successfully!</h4>
